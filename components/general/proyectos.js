      ...
      <div className="relative max-w-7xl mx-auto">
        ...
        <div className="text-center mb-20 fade-up">
          ...
          <p className="text-xl lg:text-2xl text-gray-300 max-w-3xl mx-auto">
            Nuestros proyectos reflejan excelencia y compromiso en el sector minero.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10 fade-up-delay">
          {proyectos.map((project, idx) => {
            const IconCategory = project.icons.category;
            const IconYear = project.icons.year;
            const IconDuration = project.icons.duration;

            return (
              <div
                key={project.id}
                className="group relative flex flex-col bg-white/10 backdrop-blur-xl border border-white/10 rounded-2xl overflow-hidden shadow-xl
                ...
                <div className="p-6 flex flex-col flex-1">
                  ...
                  <div className="mt-6 space-y-3 border-t border-white/10 pt-4">
                    ...
                    <div className="flex items-center text-white text-sm">
                      <IconCategory className="w-5 h-5 mr-2 text-cyan-400" />
                      {project.category}
                    </div>

                    <div className="flex items-center text-white text-sm">
                      <IconYear className="w-5 h-5 mr-2 text-cyan-400" />
                      {project.year}
                    </div>

                    <div className="flex items-center text-white text-sm">
                      <IconDuration className="w-5 h-5 mr-2 text-cyan-400" />
                      {project.duration}
                    </div>
        ...
        <div className="text-center max-w-3xl mx-auto mt-24 fade-up-slow">
          ...
          <p className="text-xl text-gray-300 mt-4">
            Te asesoramos para construir con calidad y eficiencia.
          </p>
