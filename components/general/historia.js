        ...
        <div className="container mx-auto px-4 py-16 ">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-xl lg:text-2xl text-gray-300 max-w-3xl mx-auto animate-fade-in-up delay-200">
              Más de 10 años construyendo el futuro de la industria minera con
              excelencia, innovación y un compromiso inquebrantable con nuestros
              clientes.
            </p>
          </div>
            ...
            <div className="space-y-6">
              <div className="bg-white rounded-lg shadow-sm border-l-4 border-l-orange-500">
                <div className="p-6 hover:shadow-xl transition-shadow duration-300 ">
                  ...
                  <p className="text-slate-600 leading-relaxed mb-4">
                    Fundada en 2006, Construcciones Civiles ha emergido como
                    líder en la industria de la construcción para el sector
                    minero. Con más de 18 años de experiencia, hemos completado
                    más de 300 proyectos exitosos en el Noroeste argentino y la
                    zona Precordillerana, consolidando nuestra posición como
                    expertos en construcciones especializadas para la minería.
                  </p>
                  <p className="text-slate-600 leading-relaxed">
                    Desde nuestros comienzos, hemos crecido hasta convertirnos
                    en una de las empresas de construcción minera más respetadas
                    de la región, siempre manteniendo nuestros valores
              ...
              <div className="bg-white rounded-lg shadow-sm  hover:shadow-xl transition-shadow duration-300">
                <div className="p-6">
                  ...
                  <p className="text-slate-600 leading-relaxed mb-4">
                    A lo largo de los años, hemos expandido nuestras operaciones
                    desde proyectos locales hasta convertirmos en socios
                    estratégicos de las principales compañías mineras de
                    Argentina.
                  </p>
                  <p className="text-slate-600 leading-relaxed">
                    Nuestro equipo ha crecido de 12 empleados a más de 250
                    profesionales altamente capacitados, incluyendo ingenieros,
                    técnicos especializados y operarios certificados en las más
                    altas normas de seguridad industrial.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="mb-16 px-4">
            ...
            <div className="relative">
              {/* Timeline line */}
              <div className="hidden sm:block absolute left-1/2 transform -translate-x-px h-full w-0.5 bg-gradient-to-b from-orange-400 to-blue-400"></div>
                ...
                {hitos.map((hito, index) => (
                  ...
                  >
                    ...
                    <div className="relative z-10 my-4 sm:my-0">
                      <div className="w-4 h-4 bg-white border-4 border-orange-400 rounded-full shadow-lg"></div>
                    </div>
          ...
          <div className="bg-gradient-to-r from-slate-800 to-slate-700 text-white rounded-lg shadow-sm ">
            <div className="p-8 text-center">
              ...
              <p className="text-lg leading-relaxed max-w-4xl mx-auto mb-6">
                Continuamos innovando y expandiendo nuestros servicios para
                enfrentar los desafíos del futuro de la minería. Nuestro
                compromiso con la sostenibilidad, la tecnología de vanguardia y
                la excelencia operacional nos posiciona para liderar la próxima
                generación de construcción minera.
              </p>
              <div className="my-6 h-px bg-slate-600"></div>
              <p className="text-slate-300 italic">
                &quot;Construyendo el futuro de la minería, un proyecto a la
                vez.&quot;
              </p>
            </div>
          </div>
